...
export default async function ContactCTA() {
  ...
  return (
    <section id="contact-cta" className="relative isolate overflow-hidden bg-black px-5 py-24 md:py-32">
      ...
      <div className="absolute inset-0 -z-20 bg-[radial-gradient(circle_at_18%_0%,rgba(201,146,42,.1),transparent_24%),linear-gradient(135deg,#050505,#0a0a0a_42%,#000000)]" />
      <div className="absolute inset-0 -z-10 opacity-10 [background-image:linear-gradient(90deg,rgba(201,146,42,.2)_1px,transparent_1px),linear-gradient(rgba(201,146,42,.2)_1px,transparent_1px)] [background-size:64px_64px] [mask-image:radial-gradient(ellipse_at_center,black_20%,transparent_70%)]" />
      ...
      <div className="mx-auto max-w-7xl">
        <div className="relative overflow-hidden rounded-[2.5rem] border border-white/5 bg-white/[.02] p-6 shadow-[0_20px_80px_rgba(0,0,0,.8)] backdrop-blur-3xl md:p-12 lg:p-16">
          ...
          <div className="absolute -left-40 -top-40 -z-10 h-[30rem] w-[30rem] rounded-full bg-[#C9922A] opacity-[0.12] blur-[120px] pointer-events-none" />
          <div className="absolute -bottom-40 -right-40 -z-10 h-[30rem] w-[30rem] rounded-full bg-[#f0bd5c] opacity-[0.08] blur-[100px] pointer-events-none" />

          <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr] lg:items-center">
            
            {/* Left Content */}
            <div className="animate-fade-up relative z-10">
              <div className="mb-8 inline-flex items-center gap-2.5 rounded-full border border-[#C9922A]/30 bg-[#C9922A]/10 px-5 py-2.5 text-sm font-bold tracking-wide text-[#F3CA70] backdrop-blur-md shadow-[0_0_20px_rgba(201,146,42,.15)]">
                <span className="relative flex h-2.5 w-2.5">
                  <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-[#F3CA70] opacity-75"></span>
                  <span className="relative inline-flex h-2.5 w-2.5 rounded-full bg-[#F3CA70]"></span>
                </span>
                {t('availability')}
              </div>
              ...
              <a 
                ...
                className="group mt-10 inline-flex items-center gap-3 rounded-full border border-white/10 bg-white/5 px-6 py-3.5 font-bold text-white backdrop-blur-md transition-all hover:bg-white/10 hover:border-[#C9922A]/50 hover:text-[#F3CA70] hover:shadow-[0_0_30px_rgba(201,146,42,.2)]"
              >
            ...
            <div className="relative z-10 grid gap-4 sm:grid-cols-2">
              {phones.map((phone, index) => (
                <a
                  key={phone.key}
                  href={phone.href}
                  className={`group relative flex flex-col justify-center gap-4 overflow-hidden rounded-3xl border border-white/10 bg-white/[.03] p-6 backdrop-blur-sm transition-all duration-500 hover:-translate-y-1 hover:border-[#C9922A]/40 hover:bg-white/[.06] hover:shadow-[0_10px_40px_rgba(201,146,42,.15)] ${phone.key === 'office' ? 'sm:col-span-2 sm:flex-row sm:items-center sm:justify-between sm:p-8' : ''}`}
                  style={{animationDelay: `${index * .1}s`}}
                >
                  <div className="absolute -right-8 -top-8 z-0 h-32 w-32 rounded-full bg-[#C9922A] opacity-0 blur-3xl transition-opacity duration-500 group-hover:opacity-20" />
                  
                  <div className={`relative z-10 flex ${phone.key === 'office' ? 'items-center gap-5' : 'flex-col gap-4'}`}>
                    <span className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl border border-white/10 bg-white/5 text-[#F3CA70] shadow-[inset_0_1px_1px_rgba(255,255,255,.1)] transition-all duration-300 group-hover:scale-110 group-hover:bg-[#C9922A]/20 group-hover:border-[#C9922A]/40">
                      <Phone size={24} strokeWidth={2} />
                    </span>
                    <div className="flex flex-col gap-1">
                      <span className="text-xs font-bold uppercase tracking-widest text-white/40 transition-colors group-hover:text-[#F3CA70]/80">
                  ...
                  {phone.key === 'office' && (
                    <div className="relative z-10 hidden sm:flex h-12 w-12 items-center justify-center rounded-full border border-white/10 bg-white/5 text-white/40 transition-all group-hover:border-[#C9922A]/30 group-hover:bg-[#C9922A]/10 group-hover:text-[#F3CA70]">
