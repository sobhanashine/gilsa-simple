...
export default async function Hero({locale}: {locale: Locale}) {
  ...
  return (
    <section className="relative isolate flex min-h-[calc(100svh-72px)] items-center overflow-hidden px-5 py-16 sm:py-20 md:py-24">
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-12 md:grid-cols-[1.03fr_.97fr]">
        <div className="animate-fade-up">
          ...
          <h1 className="max-w-4xl text-4xl font-black leading-[1.05] tracking-[-.045em] text-white sm:text-6xl md:text-7xl lg:text-8xl">
            {t('title')}
          </h1>
        ...
        <div className="luxury-panel animate-fade-up relative min-h-[360px] sm:min-h-[420px] md:min-h-[450px] overflow-hidden rounded-[2.25rem] p-5 md:p-7" style={{animationDelay: '.15s'}}>
          ...
          <div className="mx-auto mt-16 h-72 sm:h-80 max-w-[20rem] rounded-[2.25rem] border border-white/30 bg-gradient-to-br from-white via-zinc-200 to-zinc-600 p-5 shadow-[inset_0_0_30px_rgba(0,0,0,.18),0_24px_80px_rgba(0,0,0,.45)]">
