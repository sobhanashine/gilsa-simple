    ...
    <header className="sticky top-0 z-40 border-b border-white/10 bg-[#0a0a0b]/78 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4">
        ...
        <div className="flex items-center gap-3">
          <a href={phones[0].href} dir="ltr" className="hidden items-center gap-2 rounded-full bg-[#C9922A] px-4 py-2 font-sans text-sm font-black text-black shadow-[0_0_30px_rgba(201,146,42,.35)] transition hover:-translate-y-0.5 hover:bg-[#e1ac45] sm:inline-flex">
